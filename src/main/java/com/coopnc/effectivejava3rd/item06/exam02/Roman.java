package main.java.com.coopnc.effectivejava3rd.item06.exam02;
...
public class Roman {
	...
	// 객체 지연 초기화
	public static boolean isRomanNumeral3(String s){
		if(romanInstance == null){
			romanInstance = Pattern.compile(REGEX);
			System.out.println("# romanInstance : "+romanInstance.hashCode());
		}
